...
@section('admin-content')
    {!! breadcrumbs([
        'Admin Panel' => 'admin',
        'Shop Categories' => 'admin/data/shops/shop-categories',
        ($category->id ? 'Edit' : 'Create') . ' Category' => $category->id ? 'admin/data/shops/shop-categories/edit/' . $category->id : 'admin/data/shops/shop-categories/create',
    ]) !!}
